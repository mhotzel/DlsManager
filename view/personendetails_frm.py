...
from view.kontenliste_frm import KontenListeFrm


class PersonenDetailsFrame(ttb.Frame):
    '''Stellt die Details zu einer Person dar'''
    ...
    def _build_ui(self) -> None:
        ...
        self.fld_person_id = ttb.Entry(
            self._frm_persdet, width=10, state='readonly', textvariable=self.data['person_id'])
        ...
        self.fld_kdnr = ttb.Entry(
            self._frm_persdet, width=10, state='readonly', textvariable=self.data['kdnr'])
        ...
        self.fld_typ = ttb.Entry(
            self._frm_persdet, state='readonly', width=10, textvariable=self.data['typ'])
        ...
        self.fld_anrede = ttb.Entry(
            self._frm_persdet, state='readonly', textvariable=self.data['anrede'])
        ...
        self.fld_titel = ttb.Entry(
            self._frm_persdet, state='readonly', textvariable=self.data['titel'])
        ...
        self.fld_nachname = ttb.Entry(
            self._frm_persdet, state='readonly', textvariable=self.data['nachname'])
        ...
        self.fld_vorname = ttb.Entry(
            self._frm_persdet, state='readonly', textvariable=self.data['vorname'])
        ...
        self.fld_geboren = ttb.Entry(
            self._frm_persdet, state='readonly', width=10, textvariable=self.data['geboren'])
        ...
        self.fld_verstorben = ttb.Entry(
            self._frm_persdet, state='readonly', width=10, textvariable=self.data['verstorben'])
        ...
        self.fld_hinweise = ScrolledText(
            self._frm_hinweise, height=5, width=40, state='disabled')
        ...
        self.fld_posterg = ttb.Entry(
            self._frm_adr, state='readonly', width=36, textvariable=self.data['post_erg'])
        ...
        self.fld_strasse = ttb.Entry(
            self._frm_adr, state='readonly', width=36, textvariable=self.data['strasse'])
        ...
        self.fld_land = ttb.Entry(
            self._frm_adr, state='readonly', width=6, textvariable=self.data['land'])
        ...
        self.fld_plz = ttb.Entry(
            self._frm_adr, state='readonly', width=6, textvariable=self.data['plz'])
        ...
        self.fld_ort = ttb.Entry(
            self._frm_adr, state='readonly', width=36, textvariable=self.data['ort'])
        ...
        self.fld_tel1 = ttb.Entry(
            self._frm_adr, width=36, state='readonly', textvariable=self.data['tel1'])
        ...
        self.fld_tel2 = ttb.Entry(
            self._frm_adr, width=36, state='readonly', textvariable=self.data['tel2'])
        ...
        self.fld_email = ttb.Entry(
            self._frm_adr, width=36, state='readonly', textvariable=self.data['email'])
        self.fld_email.grid(row=7, column=1, columnspan=3,
                            sticky='WE', padx=10, pady=10)

        self.kontenliste_frm = KontenListeFrm(self, self.controller)
        self.kontenliste_frm.grid(
        ...
        self.btn_baue_adresse = ttb.Button(
            self._frm_btns, text='Adresse aufbereiten', bootstyle='secondary')
        self.btn_baue_adresse.pack(side='right', padx=10, pady=10)

        self.btn_edit = ttb.Button(
            self._frm_btns, text='Person bearbeiten', bootstyle='secondary')
        self.btn_edit.pack(side='right', padx=10, pady=10)

        self.btn_kto_anlegen = ttb.Button(
            self._frm_btns, text='Konto anlegen', bootstyle='secondary')
        self.btn_kto_anlegen.pack(side='right', padx=10, pady=10)

    def _register_bindings(self) -> None:
        '''Registriert Handler'''
        self.btn_edit.configure(
            command=lambda: self.controller.person_aendern_bildschirm_anzeigen(self.person.id))

        self.btn_kto_anlegen.configure(
            command=lambda: self.controller.konto_anlegen_anzeigen(self.person.id))

        self.btn_baue_adresse.configure(
            command=lambda: self.controller.anschrift_aufbereiten_anzeigen(self.person.id))

    def show(self, person: Person, kontenliste: Sequence[Konto]) -> None:
    ...
    def _fill_form(self) -> None:
        ...
        self.data['anrede'].set(
            self.person.anrede) if self.person.anrede != None else ''
        self.data['titel'].set(self.person.titel if self.person.titel else '')
        ...
        self.data['email'].set(self.person.email if self.person.email else '')
        self.fld_hinweise.text['state'] = 'normal'
        self.fld_hinweise.text.delete('1.0', 'end')
        self.fld_hinweise.insert(
            'end', self.person.hinweise if self.person.hinweise else '')
        self.fld_hinweise.text['state'] = 'disabled'

        self.kontenliste_frm.konten = self.kontenliste
